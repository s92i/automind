            ...
            <div className="max-w-md w-full">
                <div className="bg-[#15181e] rounded-3xl shadow-2xl px-10 py-12 text-center border border-gray-800 relative">
                    ...
                    <div className="mb-10 animate-fade-in-down">
                        <Link href="/" className="group transition-all duration-300 hover:scale-105 inline-block">
                            <Image
                    ...
                    <h1 className={`text-3xl font-extrabold mb-4 animate-fade-in-up 
                    ...
                    <p className="text-gray-400 mb-8 min-h-[32px] animate-fade-in-up" style={{ transition: "all .2s" }}>
                        {message}
                    </p>
                            ...
                            <div className="space-y-4 animate-fade-in-up">
                                <div className="flex items-center justify-center gap-2 bg-linear-to-br from-green-900 via-green-950 to-green-900 border border-green-700 rounded-xl p-4 shadow-green-100/10 shadow-sm">
                                    ...
                                    <p className="text-green-200 text-sm font-medium">
                                        Welcome to <span className="font-bold">Automind!</span> Your account is now active and ready to use.
                                    </p>
                                </div>
                ...
                <div className="text-center mt-10 animate-fade-in-up">
                    <p className="text-gray-500 text-xs sm:text-sm">
                        Need help?{' '}
                        <Link href="mailto:support@automind.com" className="text-blue-400 hover:underline font-medium transition">
                            Contact Support
                        </Link>
                    </p>
                </div>
