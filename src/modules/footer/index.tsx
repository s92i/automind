...
import { Book, Cookie, Earth, FileText, Github, MessageCircle, Scroll, Shield, Twitter, UserCheck } from "lucide-react"
            ...
            <div className="container max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    <div className="animate-fade-in">
                        ...
                        <p className="text-muted-foreground text-sm mb-6 leading-relaxed">The next-generation workflow automation platform with AI superpowers. Build, deploy and scale your automations effortlessly</p>
