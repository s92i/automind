                ...
                <div className="animate-fade-in">
                    <div className="relative mb-8">
                        ...
                        <div className="bg-gradient-card p-12 rounded-3xl border border-primary/20 backdrop-blur-sm shadow-elevated">
                            ...
                            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">Join thousands of developers and teams who trust Automind for their automation needs. Start building powerful workflows in minutes, not hours</p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                                ...
                                <Button size="lg" variant="outline" className="text-lg px-10 py-6 hover:text-white">Schedule Demo</Button>
                            </div>
